...
const HOSTED_DOCS_JA_COPY: Record<string, string> = {
    ...
    'One card, one short run of steps — here, checking a typed answer.': 'カード1枚と、短いステップの流れ。ここでは入力した解答を確認しています。',
    'The よむ subtitle line annotated over a real YouTube video, with the transcript rail open beside it.': '実際のYouTube動画の上に注釈された、よむの字幕行と、その横に開いた書き起こしパネル。',
    'The subtitle line and the transcript, on a real YouTube page.': '実際のYouTubeページ上での字幕行と書き起こし。',
    'The よむ video player with a local video open, the Japanese subtitle line annotated on the picture and the transcript rail listing every line.': 'ローカル動画を開いたよむの動画プレーヤー。映像の上に日本語の字幕行が注釈され、書き起こしパネルに全行が並んでいます。',
    'The video player, running a local file and its subtitle track.': 'ローカルファイルとその字幕トラックを再生している動画プレーヤー。',
    'A beginner Japanese conversation video playing with the よむ subtitle overlay': 'よむの字幕オーバーレイを表示しながら再生中の初級者向け日本語会話動画',
    'A beginner video with the lookup-ready subtitle overlay running.': '辞書引きに対応した字幕オーバーレイが動作している初級者向けの動画。',
