...
The filter pairs with よむ's [subtitle tools](/tools/japanese-subtitle-reader): Japanese lines become lookup-ready with a transcript panel and sentence mining to Jiten, JPDB, or Anki. Filtering finds the videos; the subtitle reader makes them comprehensible.
