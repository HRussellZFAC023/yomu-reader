...
- **Mine and review while reading:** create Anki cards or add words to Academy, Jiten, Bunpro, or JPDB with source context. Anki field suggestions and sentence boundaries follow the selected reading language; review Bunpro and currently due WaniKani assignments safely from their live queues.
