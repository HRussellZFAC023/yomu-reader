...
**Current delivery checkpoint:** the delivery tree is synchronized through Reader `v1.7.0`; shared story, audio, N3, account lifecycle, workflow, retained upstream work, and the approved Aakash `v009` runtime promotion are consolidated. The executable Day 1 availability manifest enumerates 52 learner-facing surfaces and 260 closure proofs across implementation, reachability, media, persistence, and full-journey evidence. The first Rie greeting, vowel listening, repeatable listening bingo, five-kana writing, classroom-instruction rehearsal, understanding/repair rehearsal, living desk-language lesson, five connected first-sentence frames, saved-name `です` transfer, and the two-speaker name-listening mission now account for 27 verified dimensions, 23 partial dimensions, and 210 unverified dimensions. The name-card draft reuses the learner name chosen during arrival, asks for one N+1 ordering move, records repair and one canonical SRS seed, resumes durably, and is keyboard/touch accessible and browser-proved on phone, portrait tablet, and desktop. It does not duplicate name capture or pretend a Lesson Zero beginner can transcribe an arbitrary name into katakana; that skill remains in the adaptive kana game and later name-card activities. The name-listening mission is the first strict closure: it teaches one useful sound landmark before testing, plays exact Aivis Opus lines, withholds transcripts until commitment, records a deliberate lapse and canonical SRS evidence, replays only the missed voice, survives Back and reopen, satisfies the authored story gate, returns to the exact cursor, and resumes with Mika visibly speaking on phone, portrait tablet, and desktop. Strict Day 1 closure is therefore `1/52`; partial evidence never counts as a completed activity. The active task is to close every remaining required, optional, and repeatable row in chronological order through the complete welcome-to-first-evening journey.
