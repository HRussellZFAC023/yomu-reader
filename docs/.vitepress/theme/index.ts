...
const HOSTED_DOCS_JA_COPY: Record<string, string> = {
    ...
    'Polished learner stories with notes and audio. よむ adds your normal Jiten, Yomitan, Anki, and JPDB flow on top.': '注釈と音声つきの洗練された学習者向けストーリーです。よむを重ねると、いつものJiten、Yomitan、Anki、JPDBフローも使えます。',
    'Watanoc': 'Watanoc',
    ...
    'Polished learner stories with notes and audio. よむ adds your usual Jiten, Yomitan, Anki, and JPDB flow on top.': '注釈と音声が付いた、洗練された学習者向けストーリーです。よむを重ねることで、いつものJiten、Yomitan、Anki、JPDBフローも利用できます。',
