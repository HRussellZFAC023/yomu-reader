...
const HOSTED_DOCS_JA_COPY: Record<string, string> = {
    ...
    ', and the dictionary catalogue carries headwords across all of them. The interface itself speaks English and 日本語.': 'と表示され、辞書カタログにはその全言語の見出し語があります。インターフェースは英語と日本語に対応しています。',
