import { TRANSCRIPT_PANEL_MARGIN, type TranscriptPanelLayout } from './subtitle-layout';
...
export function transcriptResizeBounds(viewportWidth: number, viewportHeight: number): TranscriptResizeBounds {
    return {
        maxBottomHeight: Math.max(TRANSCRIPT_PANEL_MIN_BOTTOM_HEIGHT, viewportHeight - TRANSCRIPT_PANEL_MARGIN * 3),
