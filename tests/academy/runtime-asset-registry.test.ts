...
describe('Academy runtime asset registry', () => {
    ...
    it('wires only likeness-cleared cast performances into the approved sprite map', () => {
        ...
        for (const id of [
            ...
            'character.ruparna.neutral-long-dark-hair-subtitle-strips-front-near-front-fullbody-v003',
            'character.ruparna.encouraging-listening-long-dark-hair-subtitle-strips-right-three-quarter-fullbody-v003',
