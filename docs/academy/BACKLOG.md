...
**Active task:** `day:1:lesson-zero:03` - close five-vowel writing with the same N+1 anchors, no assumed kana, stroke-plan and drawing-equivalent routes, useful repair, delayed recall, SRS handoff, responsive accessibility and clean browser proof; then continue through each standalone Lesson Zero activity in order before closing its composite games, World, social, study, wiki, accessibility, journal and evening rows.
