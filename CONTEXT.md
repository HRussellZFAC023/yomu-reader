...
- Verified Support Receipt: One authenticated provider payment stored under its stable provider identity, with the native amount preserved and its canonical GBP accounting value recorded separately. Academy entitlement is a separate downstream concern.
