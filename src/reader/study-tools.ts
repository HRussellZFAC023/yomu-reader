...
const GRAMMAR_PATTERNS: GrammarPattern[] = [
    gp("potential-koto-ga-dekiru", "N4", "ことができる", `${FORM_CHUNK}ことができ(?:る|ます|ない|ません|た|ました|なかった|ませんでした)?`, "https://www.tofugu.com/japanese-grammar/koto-ga-dekiru/", "high", 5),
    gp("potential-dekiru", "N4", "できる", `${PARTICLE_CHUNK}でき(?:る|ます|た|ました|ない|ません|なかった|ませんでした)`, "", "high", 8),
    gp("obligation-nakereba-naranai", "N4", "なければならない", `${FORM_CHUNK}(?:なければならない|なければなりません|なくてはならない|なくてはなりません|なくてはいけない|なくてはいけません|なければいけない|なければいけません|なきゃ(?:いけない|だめ)?|なくちゃ(?:いけない|だめ)?|ないといけない|ねばならない)`, "https://www.tofugu.com/japanese-grammar/nakereba-naranai/", "high", 4),
    gp("permission-not-required-nakutemo-ii", "N5", "なくてもいい", `${FORM_CHUNK}なくても(?:いい|よい|大丈夫)(?:です)?`, "", "high", 4),
    gp("prohibition-tewa-ikenai", "N4", "てはいけない", `${FORM_CHUNK}(?:(?:[てで]は|ちゃ|じゃ)いけ(?:ない|ません|なかった|ませんでした)|(?:[てで]は|ちゃ|じゃ)なら(?:ない|ません)|(?:[てで]は|ちゃ|じゃ)だめ(?:だ|です)?)`, "https://www.tofugu.com/japanese-grammar/tewa-ikenai/", "high", 5),
    gp("permission-temo-ii", "N5", "てもいい", `${FORM_CHUNK}[てで]も(?:いい|よい|よかった|よくない|よくありません|大丈夫(?:です)?|かまわない|かまいません|構わない|構いません)(?:です)?`, "https://www.tofugu.com/japanese-grammar/temoii/", "high", 5),
    gp("request-te-kudasai", "N5", "てください", `${FORM_CHUNK}[てで]ください(?:ませんか)?`, "", "high", 6),
    gp("polite-request-te-itadakemasen-ka", "N4", "ていただけませんか", `${FORM_CHUNK}[てで](?:いただけませんか|くださいませんか)`, "", "high", 6),
    gp("request-naide-kudasai", "N5", "ないでください", `${FORM_CHUNK}ないでください`, "", "high", 5),
    gp("advice-hou-ga-ii", "N4", "方がいい", `${FORM_CHUNK}ほうが(?:いい|よい)(?:です)?`, "", "high", 6),
    gp("command-nasai", "N4", "なさい", `${FORM_CHUNK}なさい`, "", "high", 6),
    gp("experience-ta-koto-ga-aru", "N4", "たことがある", `${FORM_CHUNK}たことが(?:あ(?:る|ります|った|りました|りません|りませんでした)|ない|なかった|ありません|ありませんでした)`, "https://www.tofugu.com/japanese-grammar/ta-koto-ga-aru/", "high", 6),
    gp("completion-te-shimau", "N4", "てしまう", `(?:${FORM_CHUNK}[てで]しま(?:う|います|った|いました|わない|いません|わなかった|いませんでした)|${FORM_CHUNK}(?:ちゃう|ちゃいます|ちゃった|ちゃいました|ちゃわない|ちゃいません|ちゃわなかった|ちゃいませんでした|じゃう|じゃいます|じゃった|じゃいました|じゃわない|じゃいません|じゃわなかった|じゃいませんでした))`, "https://www.tofugu.com/japanese-grammar/te-shimau/", "high", 6),
    gp("attempt-te-miru", "N4", "てみる", `${FORM_CHUNK}[てで]み(?:る|ます|た|ました|たい|ない|ません|なかった|ませんでした)`, "https://www.tofugu.com/japanese-grammar/te-miru/", "high", 6),
    gp("preparation-te-oku", "N4", "ておく", `(?:${FORM_CHUNK}[てで]お(?:く|きます|いた|きました|かない|きません|かなかった|きませんでした)|${FORM_CHUNK}(?:とく|ときます|といた|ときました|とかない|ときません|とかなかった|ときませんでした|どく|どきます|どいた|どきました|どかない|どきません|どかなかった|どきませんでした))`, "https://www.tofugu.com/japanese-grammar/teoku/", "high", 6),
    gp("desire-other-te-hoshii", "N4", "てほしい", `${FORM_CHUNK}[てで]ほし(?:い|いです|かった|かったです|くない|くありません|くなかった|くありませんでした)`, "", "high", 7),
    gp("benefactive-te-kureru-morau", "N4", "てくれる / てもらう", `${FORM_CHUNK}[てで](?:くれ(?:る|ます|た|ました|ない|ません|なかった|ませんでした)|くださ(?:る|います|った|いました|らない|いません|らなかった|いませんでした)|あげ(?:る|ます|た|ました|ない|ません|なかった|ませんでした)|や(?:る|ります|った|りました|らない|りません|らなかった|りませんでした)|もら(?:う|います|った|いました|わない|いません|わなかった|いませんでした|え(?:る|ます|た|ました|ない|ません|なかった|ませんでした))|いただ(?:く|きます|いた|きました|かない|きません|かなかった|きませんでした|け(?:る|ます|た|ました|ない|ません|なかった|ませんでした)))`, "https://www.tofugu.com/japanese-grammar/te-kureru/", "medium", 8),
    gp("change-you-ni-naru", "N4", "ようになる", `${FORM_CHUNK}ようにな(?:る|ります|った|りました|らない|りません|らなかった|りませんでした|っている|っています|っていない|っていません)`, "https://www.tofugu.com/japanese-grammar/you-ni-naru/", "high", 8),
    gp("habit-you-ni-suru", "N4", "ようにする", `${FORM_CHUNK}ように(?:す(?:る|ます|た|ました)|し(?:ます|た|ました|ている|ています|ていない|ていません|ない|ません|なかった|ませんでした))`, "https://www.tofugu.com/japanese-grammar/you-ni-suru/", "high", 8),
    gp("verb-suru", "N5", "する", `(?:${PARTICLE_CHUNK}を)?${PARTICLE_CHUNK}(?:す(?:る|れば|るな|るの|ること|るため|る前|る後)|し(?:ます|ました|ません|ませんでした|た|て|ない|なかった|なければ|よう|ろ)|され(?:る|ます|た|ました)|させ(?:る|ます|た|ました)|でき(?:る|ます|た|ました|ない|ません))`, "https://www.tofugu.com/japanese-grammar/suru/", "high", 49),
    gp("choice-ni-suru", "N4", "にする", `${PARTICLE_CHUNK}に(?:す(?:る|ます|た|ました)|し(?:ます|た|ました|ている|ています|ない|ません|なかった|ませんでした))`, "", "high", 10),
    gp("change-ku-suru", "N4", "くする", `${PARTICLE_CHUNK}く(?:す(?:る|ます|た|ました)|し(?:ます|た|ました|ている|ています|ない|ません|なかった|ませんでした))`, "", "high", 10),
    gp("change-ku-naru-ni-naru", "N5", "くなる / になる", `(?:${PARTICLE_CHUNK}くな(?:る|ります|った|りました|らない|りません|らなかった|りませんでした|っている|っています)|${PARTICLE_CHUNK}(?<!よう)にな(?:る|ります|った|りました|らない|りません|らなかった|りませんでした|っている|っています)|${PARTICLE_CHUNK}とな(?:る|ります|った|りました))`, "", "high", 10),
    gp("copula-desu-da", "N5", "です / だ", `(?:です|でした|だ|だった)(?=$|[、。！？!?よねな])`, "https://www.tofugu.com/japanese-grammar/desu/", "high", 43),
    gp("negative-copula-dewa-nai", "N5", "ではない / じゃない", `(?:では|じゃ)(?:ない|ありません|なかった|ありませんでした)`, "", "high", 12),
    gp("formal-copula-de-aru", "N3", "である", `であ(?:る|ります|った|りました)`, "", "high", 20),
    gp("voice-causative-passive", "N3", "させられる", `${FORM_CHUNK}(?:させられ(?:る|ます|た|ました|ない|ません|なかった|ませんでした)|[かがさざただなばまらわ]せられ(?:る|ます|た|ました|ない|ません|なかった|ませんでした)|[かがさざただなばまらわ]され(?:る|ます|た|ました|ない|ません|なかった|ませんでした))`, "https://www.tofugu.com/japanese-grammar/verb-causative-form-saseru/", "medium", 8),
    gp("voice-causative", "N4", "させる", `${FORM_CHUNK}(?:させ(?:る|ます|た|ました|ない|ません|なかった|ませんでした)|[かがさざただなばまらわ]せ(?:る|ます|た|ました|ない|ません|なかった|ませんでした))`, "https://www.tofugu.com/japanese-grammar/verb-causative-form-saseru/", "medium", 9),
    gp("voice-passive-potential", "N4", "れる / られる", `${FORM_CHUNK}(?:られ(?:る|ます|た|ました|ない|ません|なかった|ませんでした)|[かがさざただなばまわ]れ(?:る|ます|た|ました|ない|ません|なかった|ませんでした))`, "https://www.tofugu.com/japanese-grammar/verb-passive-form-rareru/", "medium", 9),
    gp("evidence-rashii-mitai", "N4", "らしい / みたい", `(?:${FORM_CHUNK}らし(?:い|かった|くない|く)|${FORM_CHUNK}みたい(?:だ|です|でした|じゃない|ではない|に|な)?(?=$|[、。！？!?ねよ]))`, "https://www.tofugu.com/japanese-grammar/rashii/", "medium", 9),
    gp("modality-kamoshirenai", "N4", "かもしれない", "(?:かもしれない|かもしれません|かも)", "https://www.tofugu.com/japanese-grammar/kamoshirenai/", "high", 9),
    gp("modality-deshou-darou", "N5", "でしょう / だろう", "(?:でしょう|でしょうか|だろう|だろうか)", "https://www.tofugu.com/japanese-grammar/deshou/", "high", 10),
    gp("quotation-to-omou", "N4", "と思う", `${FORM_CHUNK}と思(?:う|います|った|いました|っている|っています|わない|いません|わなかった|いませんでした)`, "https://www.tofugu.com/japanese-grammar/to-omou/", "high", 10),
    gp("attempt-you-to-suru", "N3", "ようとする", `${FORM_CHUNK}ようと(?:す(?:る|ます|た|ました|ている|ています)|し(?:ます|た|ました|ている|ています|ない|ません|なかった|ませんでした))`, "https://www.tofugu.com/japanese-grammar/verb-volitional-form-you/", "medium", 11),
    gp("plan-tsumori-yotei", "N4", "つもり / 予定", `${FORM_CHUNK}(?:つもり|予定)(?:だ|です|だった|でした)?`, "https://www.tofugu.com/japanese-grammar/tsumori/", "medium", 12),
    gp("expectation-hazu", "N4", "はず", `${FORM_CHUNK}はず(?:だ|です|だった|でした|がない|はない)?`, "https://www.tofugu.com/japanese-grammar/hazu/", "high", 12),
    gp("reasoning-wake", "N3", "わけ", `${FORM_CHUNK}わけ(?:ではない|じゃない|がない|にはいかない|だ|です)?`, "https://www.tofugu.com/japanese-grammar/wake/", "medium", 24),
    gp("reasoning-wake-dewa-nai", "N3", "わけではない", `${FORM_CHUNK}わけ(?:では|じゃ)(?:ない|ありません)`, "", "high", 11),
    gp("impossibility-wake-ga-nai", "N3", "わけがない", `${FORM_CHUNK}わけが(?:ない|ありません)`, "", "high", 11),
    gp("constraint-wake-ni-wa-ikanai", "N3", "わけにはいかない", `${FORM_CHUNK}わけにはい(?:かない|きません)`, "", "high", 11),
    gp("purpose-tame-ni", "N4", "ために", `${FORM_CHUNK}ために`, "https://www.tofugu.com/japanese-grammar/tame-ni/", "high", 12),
    gp("purpose-you-ni", "N4", "ように", `${FORM_CHUNK}ように`, "https://www.tofugu.com/japanese-grammar/you-ni/", "medium", 28),
    gp("timing-tokoro", "N4", "ところ", `${FORM_CHUNK}ところ(?:だ|です|だった|でした|で|に)?`, "https://www.tofugu.com/japanese/tokoro-bakari/", "medium", 14),
    gp("simultaneous-nagara", "N4", "ながら", `${FORM_CHUNK}(?<!残念)ながら`, "https://www.tofugu.com/japanese-grammar/nagara/", "high", 14),
    gp("state-mama", "N3", "まま", `${FORM_CHUNK}まま`, "https://www.tofugu.com/japanese-grammar/mama/", "medium", 15),
    gp("list-tari", "N5", "たり", `(?:[^、。！？!?\\s]{1,30}?[だた]り[^、。！？!?\\s]{1,30}?[だた]り(?:する|します|した|しました|しない|しません|しなかった|しませんでした)?|${FORM_CHUNK}[だた]り(?:する|します|した|しました|しない|しません|しなかった|しませんでした))`, "https://www.tofugu.com/japanese-grammar/tari/", "medium", 16),
    gp("limitation-bakari", "N4", "ばかり", `${FORM_CHUNK}ばかり`, "https://www.tofugu.com/japanese/tokoro-bakari/", "medium", 16),
    gp("recent-ta-bakari", "N4", "たばかり", `${FORM_CHUNK}たばかり(?:だ|です|だった|でした)?`, "https://www.tofugu.com/japanese/tokoro-bakari/", "high", 12),
    gp("limitation-dake-shika", "N5", "だけ / しか", `${FORM_CHUNK}(?:だけ|しか)`, "https://www.tofugu.com/japanese-grammar/dake/", "medium", 18),
    gp("degree-hodo-kurai", "N4", "ほど / くらい", `${FORM_CHUNK}(?:ほど|くらい|ぐらい)`, "https://www.tofugu.com/japanese-grammar/hodo/", "medium", 18),
    gp("role-toshite", "N3", "として", `${FORM_CHUNK}として`, "", "high", 18),
    gp("relation-ni-yotte", "N3", "によって", `${FORM_CHUNK}によ(?:って|る)`, "", "medium", 18),
    gp("topic-ni-tsuite", "N3", "について", `${FORM_CHUNK}について`, "", "high", 18),
    gp("target-ni-taishite", "N3", "に対して", `${FORM_CHUNK}に対(?:して|する|し)`, "", "medium", 18),
    gp("concession-ni-mo-kakawarazu", "N2", "にもかかわらず", `${FORM_CHUNK}にもかかわらず`, "", "high", 18),
    gp("concession-kuse-ni", "N3", "くせに", `${FORM_CHUNK}くせに`, "", "medium", 18),
    gp("suffix-tachi", "N5", "たち / 達", `${PARTICLE_CHUNK}(?:たち|(?<!友)達)`, "", "medium", 50),
    gp("particle-wa", "N5", "は", `${PARTICLE_CHUNK}は(?!ず)`, "https://www.tofugu.com/japanese-grammar/particle-wa/", "high", 55),
    gp("particle-ga", "N5", "が", `${PARTICLE_CHUNK}が`, "https://www.tofugu.com/japanese-grammar/particle-ga/", "high", 55),
    gp("particle-wo", "N5", "を", `${PARTICLE_CHUNK}を`, "https://www.tofugu.com/japanese-grammar/particle-wo/", "high", 55),
    gp("particle-de", "N5", "で", `${PARTICLE_CHUNK}(?<![まん])で(?!き|す|し)`, "https://www.tofugu.com/japanese-grammar/particle-de/", "medium", 55),
    gp("particle-ni", "N5", "に", `${PARTICLE_CHUNK}に(?!なる)`, "https://www.tofugu.com/japanese-grammar/particle-ni/", "medium", 55),
    gp("particle-e", "N5", "へ", `${PARTICLE_CHUNK}へ`, "", "medium", 55),
    gp("particle-to", "N5", "と", `${PARTICLE_CHUNK}(?<![っッこコ])と(?!して|いう|思)`, "https://www.tofugu.com/japanese-grammar/particle-to/", "medium", 55),
    gp("particle-no", "N5", "の", `${PARTICLE_CHUNK}の`, "https://www.tofugu.com/japanese-grammar/particle-no-noun-modifier/", "medium", 55),
    gp("particle-mo", "N5", "も", `${PARTICLE_CHUNK}も`, "", "medium", 55),
    gp("particle-ya", "N5", "や", `${PARTICLE_CHUNK}や`, "", "medium", 55),
    gp("aspect-te-iru", "N5", "ている", `${FORM_CHUNK}[てで](?:いる|います|いた|いました|いない|いません|いなかった|いませんでした|る|た)`, "https://www.tofugu.com/japanese-grammar/verb-continuous-form-teiru/", "high", 40),
    gp("aspect-te-aru", "N4", "てある", `${FORM_CHUNK}[てで]あ(?:る|ります|った|りました|らない|りません|らなかった|りませんでした)`, "", "high", 12),
    gp("aspect-te-kuru", "N4", "てくる", `${FORM_CHUNK}[てで](?:くる|きます|きた|きました|こない|きません|こなかった|きませんでした)`, "", "medium", 20),
    gp("aspect-te-iku", "N4", "ていく", `${FORM_CHUNK}[てで]い(?:く|きます|った|きました|かない|きません|かなかった|きませんでした)`, "", "medium", 20),
    gp("desire-tai", "N5", "たい", `${FORM_CHUNK}(?:たい(?:です)?|たく(?:ない|ありません|なかった|ありませんでした)|たかった(?:です)?)`, "https://www.tofugu.com/japanese-grammar/tai-form/", "high", 44),
    gp("ease-yasui-nikui", "N4", "やすい / にくい", `${FORM_CHUNK}(?:やすい|にくい|づらい)`, "", "high", 22),
    gp("excess-sugiru", "N4", "すぎる", `${FORM_CHUNK}すぎ(?:る|ます|た|ました|て|ない|ません|なかった|ませんでした|だ|です)`, "", "high", 22),
    gp("method-kata", "N5", "方", `${FORM_CHUNK}方`, "", "medium", 48),
    gp("negative-nai", "N5", "ない", `${FORM_CHUNK}(?:ない|ません|なかった|ませんでした)`, "https://www.tofugu.com/japanese-grammar/verb-negative-nai-form/", "medium", 46),
    gp("polite-past-mashita", "N5", "ました", `${FORM_CHUNK}ました`, "https://www.tofugu.com/japanese-grammar/masu/", "high", 44),
    gp("polite-masu", "N5", "ます", `${FORM_CHUNK}ます`, "https://www.tofugu.com/japanese-grammar/masu/", "medium", 45),
    gp("conditional-tara", "N4", "たら", `${FORM_CHUNK}たら`, "https://www.tofugu.com/japanese-grammar/conditional-form-tara/", "high", 17),
    gp("conditional-ba", "N4", "ば", `${FORM_CHUNK}(?:えば|ければ)`, "https://www.tofugu.com/japanese-grammar/verb-conditional-form-ba/", "high", 18),
    gp("conditional-ba-ii", "N4", "ばいい / ばよかった", `${FORM_CHUNK}(?:えば|ければ|[えけげせてねべめれ]ば)(?:いい|よい|よかった)(?:です)?`, "", "medium", 13),
    gp("conditional-nara", "N4", "なら", `${FORM_CHUNK}なら(?:ば)?`, "", "high", 18),
    gp("conditional-to", "N4", "と", `${FORM_CHUNK}と(?=、)`, "", "medium", 38),
    gp("concession-temo-demo", "N4", "ても / でも", `${FORM_CHUNK}[てで]も`, "https://www.tofugu.com/japanese-grammar/temo/", "medium", 28),
    gp("reason-node", "N4", "ので", "(?:なので|ので)(?!は)", "https://www.tofugu.com/japanese-grammar/conjunctive-particle-node/", "high", 22),
    gp("reason-kara", "N5", "から", `${FORM_CHUNK}から`, "https://www.tofugu.com/japanese-grammar/particle-kara/", "medium", 35),
    gp("appearance-sou", "N4", "そう", `${FORM_CHUNK}そう(?:に|な)?`, "https://www.tofugu.com/japanese-grammar/verb-sou/", "medium", 30),
    gp("hearsay-sou-da", "N4", "そうだ", `${FORM_CHUNK}(?:る|い|だ|た|ない)そう(?:だ|です)`, "", "medium", 19),
    gp("volitional-you", "N5", "よう", `${FORM_CHUNK}(?:よう|ろう)`, "https://www.tofugu.com/japanese-grammar/verb-volitional-form-you/", "medium", 45),
    gp("concession-noni", "N4", "のに", "のに", "https://www.tofugu.com/japanese-grammar/conjunctive-particle-noni/", "high", 20),
    gp("nominalizer-koto", "N5", "こと", "こと(?:が|を|に|は|も)", "https://www.tofugu.com/japanese-grammar/koto/", "medium", 42),
    gp("plain-past-ta", "N5", "た", `(?:${FORM_CHUNK}(?:かった|だった|った|いた|いだ|(?<!で)した|んだ|[きぎしじちにびみりえけげせてねべめれ]た|[来見寝出]た)|(?<!で)した)(?![いらり])`, "", "medium", 47),
    gp("sequence-te-kara", "N5", "てから", `${FORM_CHUNK}[てで]から`, "", "high", 13),
    gp("time-mae-ni", "N5", "前に", `${FORM_CHUNK}前に`, "", "medium", 22),
    gp("time-ato-de-ni", "N5", "後で / 後に", `${FORM_CHUNK}後(?:で|に)`, "", "medium", 22),
    gp("time-toki", "N5", "とき", `${FORM_CHUNK}とき`, "", "medium", 22),
    gp("limit-made-made-ni", "N5", "まで / までに", `${FORM_CHUNK}まで(?:に)?`, "", "medium", 28),
    gp("comparison-yori-nohou", "N5", "より / の方が", `${FORM_CHUNK}(?:より|のほうが|の方が)`, "", "medium", 30),
    gp("superlative-ichiban", "N5", "一番", "一番", "", "high", 22),
    gp("question-ka-douka", "N4", "かどうか", `${FORM_CHUNK}かどうか`, "", "high", 13),
    gp("purpose-masu-stem-ni-iku", "N5", "に行く / に来る", `${FORM_CHUNK}[いきぎしじちにびみりえけげせてねべめ見寝出]に(?:行(?:く|きます|った|きました)|来(?:る|ます|た|ました)|帰(?:る|ります|った|りました))`, "", "high", 14),
    gp("nominalizer-no", "N5", "の", `${FORM_CHUNK}の(?=[はがをにも])`, "https://www.tofugu.com/japanese-grammar/no-nominalizer/", "medium", 18),
    gp("quotation-to-iu", "N4", "という", `${FORM_CHUNK}という`, "", "medium", 14),
    gp("casual-tte", "N4", "って", `${FORM_CHUNK}って(?=(?:言|聞|思|呼|書|いう|こと|、|。|？|!|！|$))`, "", "medium", 24),
    gp("explanation-n-desu", "N5", "んです / のです", `${FORM_CHUNK}(?:ん|の)です`, "", "medium", 22),
    gp("explanation-no-da", "N4", "のだ / んだ", `${FORM_CHUNK}(?:の|ん)(?:だ|だった|じゃない|ではない)`, "", "medium", 22),
    gp("existence-ga-aru-iru", "N5", "がある / がいる", `${PARTICLE_CHUNK}が(?:あ(?:る|ります|った|りました|らない|りません|らなかった|りませんでした)|い(?:る|ます|た|ました|ない|ません|なかった|ませんでした))`, "", "high", 24),
    gp("skill-ga-suki-jouzu-heta", "N5", "が好き / が上手 / が下手", `${PARTICLE_CHUNK}が(?:好き|すき|上手|じょうず|下手|へた)(?:だ|です|ではない|じゃない)?`, "", "high", 18),
    gp("skill-no-ga-suki", "N5", "のが好き", `${FORM_CHUNK}のが(?:好き|すき|嫌い|きらい|上手|じょうず|下手|へた|得意|苦手)(?:だ|です|ではない|じゃない)?`, "", "high", 16),
    gp("invitation-mashou", "N5", "ましょう / ましょうか", `${FORM_CHUNK}ましょう(?:か)?`, "", "high", 12),
    gp("invitation-masen-ka", "N5", "ませんか", `${FORM_CHUNK}ませんか`, "", "high", 11),
    gp("relief-te-yokatta", "N4", "てよかった", `${FORM_CHUNK}[てで]よかった(?:です)?`, "", "high", 10),
    gp("without-zuni", "N4", "ずに", `${FORM_CHUNK}ずに`, "", "high", 12),
    gp("without-naide", "N4", "ないで", `${FORM_CHUNK}ないで(?!ください)`, "", "high", 16),
    gp("apology-te-sumimasen", "N4", "てすみません", `${FORM_CHUNK}[てで]すみません`, "", "high", 10),
    gp("necessity-ga-hitsuyou", "N4", "が必要", `${PARTICLE_CHUNK}が必要(?:だ|です|だった|でした)?`, "", "high", 15),
    gp("sensation-ga-suru", "N4", "がする", `${PARTICLE_CHUNK}が(?:す(?:る|ます|た|ました)|し(?:ます|た|ました|ている|ています|ない|ません|なかった|ませんでした))`, "", "high", 13),
    gp("case-baai", "N4", "場合", `${FORM_CHUNK}場合(?:は|には)?`, "", "high", 16),
    gp("examples-nado", "N4", "など", `${PARTICLE_CHUNK}など`, "", "high", 16),
    gp("examples-toka", "N4", "とか", `${FORM_CHUNK}とか(?:${FORM_CHUNK}とか)?`, "", "medium", 18),
    gp("hearsay-to-iwarete-iru", "N4", "と言われている", `${FORM_CHUNK}と言われてい(?:る|ます|ない|ません)|${FORM_CHUNK}と言われ(?:た|ました)`, "", "high", 10),
    gp("hearsay-to-kiita", "N4", "と聞いた", `${FORM_CHUNK}と聞(?:いた|きました|いている|いています)`, "", "high", 12),
    gp("similarity-you-da", "N4", "ようだ / ような", `${FORM_CHUNK}よう(?:だ|です|な|に)`, "", "medium", 29),
    gp("permission-sasete-kudasai", "N4", "させてください", `${FORM_CHUNK}させてください`, "", "high", 5),
    gp("decision-koto-ni-suru", "N4", "ことにする", `${FORM_CHUNK}ことに(?:す(?:る|ます|た|ました|ている|ています)|し(?:ます|た|ました|ている|ています|ていない|ていません|ない|ません|なかった|ませんでした))`, "", "high", 9),
    gp("arrangement-koto-ni-naru", "N4", "ことになる", `${FORM_CHUNK}ことにな(?:る|ります|った|りました|らない|りません|らなかった|りませんでした|っている|っています)`, "", "high", 9),
    gp("honorific-o-go-ni-naru-suru", "N3", "お〜になる / お〜する", `(?:お|ご)${FORM_CHUNK}(?:になる|になります|する|します|いたす|いたします|ください)`, "", "medium", 8),
    gp("polite-gozaimasu", "N5", "ございます", `${FORM_CHUNK}ござい(?:ます|ました|ません|ませんでした)`, "", "medium", 30),
    gp("advice-beki", "N3", "べき", `${FORM_CHUNK}べき(?:だ|です|ではない|じゃない)?`, "", "high", 15),
    gp("time-aida-aida-ni", "N4", "間 / 間に", `${FORM_CHUNK}間(?:に|は)?`, "", "medium", 22),
    gp("time-uchi-ni", "N3", "うちに", `${FORM_CHUNK}うちに`, "", "medium", 14),
    gp("time-saichuu-ni", "N3", "最中に", `${FORM_CHUNK}最中に`, "", "high", 16),
    gp("repetition-tabi-ni", "N3", "たびに", `${FORM_CHUNK}たびに`, "", "high", 14),
    gp("incidental-tsuide-ni", "N3", "ついでに", `${FORM_CHUNK}ついでに`, "", "medium", 14),
    gp("phase-compound-verb", "N4", "始める / 続ける / 終わる", `${FORM_CHUNK}(?:(?:始め|続け)(?:る|ます|た|ました|ている|ています|ていない|ていません|ない|ません|なかった|ませんでした)|(?:出し|終わ)(?:る|ます|た|ました))`, "", "medium", 18),
    gp("state-ppanashi", "N3", "っぱなし", `${FORM_CHUNK}っぱなし`, "", "high", 14),
    gp("covered-darake", "N3", "だらけ", `${FORM_CHUNK}だらけ`, "", "high", 15),
    gp("fresh-tate", "N3", "たて", `${FORM_CHUNK}たて`, "", "medium", 18),
    gp("elapsed-buri-ni", "N3", "ぶりに", `${FORM_CHUNK}ぶりに`, "", "high", 14),
    gp("interval-goto-ni", "N3", "ごとに", `${FORM_CHUNK}ごとに`, "", "high", 14),
    gp("interval-oki-ni", "N3", "おきに", `${FORM_CHUNK}おきに`, "", "high", 15),
    gp("emphasis-kara-koso", "N3", "からこそ", `${FORM_CHUNK}からこそ`, "", "high", 12),
    gp("source-ni-yoru-to", "N3", "によると / によれば", `${FORM_CHUNK}によ(?:ると|れば)`, "", "high", 12),
    gp("topic-ni-kansuru", "N3", "に関する", `${FORM_CHUNK}に関する`, "", "high", 13),
    gp("context-ni-okeru", "N3", "における", `${FORM_CHUNK}における`, "", "high", 13),
    gp("standard-ni-shite-wa", "N3", "にしては", `${FORM_CHUNK}にしては`, "", "high", 14),
    gp("simultaneous-to-douji-ni", "N3", "と同時に", `${FORM_CHUNK}と同時に`, "", "high", 12),
    gp("supposition-to-shitara", "N3", "としたら / とすれば", `${FORM_CHUNK}と(?:したら|すれば|すると)`, "", "high", 13),
    gp("almost-tokoro-datta", "N3", "ところだった", `${FORM_CHUNK}ところ(?:だった|でした)`, "", "high", 12),
    gp("nonlimiting-wa-mochiron", "N3", "はもちろん", `${FORM_CHUNK}はもちろん`, "", "high", 14),
    gp("pretend-furi-wo-suru", "N3", "ふりをする", `${FORM_CHUNK}ふりを(?:す(?:る|ます|た|ました)|し(?:ます|た|ました|ている|ています))`, "", "high", 12),
    gp("instant-ta-totan-ni", "N3", "たとたんに", `${FORM_CHUNK}たとたん(?:に)?`, "", "high", 12),
    gp("difficulty-gatai", "N3", "がたい", `${FORM_CHUNK}がたい`, "", "high", 18),
    gp("only-shika-nai", "N3", "しかない", `${FORM_CHUNK}しか(?:ない|ありません|なかった|ありませんでした)`, "", "high", 12),
    gp("emphasis-sae", "N3", "さえ / でさえ", `[^、。！？!?\s]{1,24}(?:で)?さえ`, "", "medium", 18),
    gp("emphasis-koso", "N3", "こそ", `${PARTICLE_CHUNK}こそ`, "", "medium", 18),
    gp("try-te-goran", "N3", "てごらん", `${FORM_CHUNK}[てで]ごらん`, "", "high", 13),
    gp("cause-sei-okage-de", "N3", "せいで / おかげで", `${FORM_CHUNK}(?:せい|おかげ)で`, "", "high", 14),
    gp("manner-toori", "N3", "とおり", `${FORM_CHUNK}(?:とおり|通り)(?:に|だ|です)?`, "", "high", 16),
    gp("certainty-ni-chigai-nai", "N3", "に違いない", `${FORM_CHUNK}に違い(?:ない|ありません)`, "", "high", 15),
    gp("certainty-ni-kimatte-iru", "N3", "に決まっている", `${FORM_CHUNK}に決まってい(?:る|ます)`, "", "high", 15),
    gp("qualification-to-wa-kagiranai", "N3", "とは限らない", `${FORM_CHUNK}とは限(?:らない|りません)`, "", "high", 15),
    gp("contrast-ippou-de", "N3", "一方で", `${FORM_CHUNK}一方(?:で)?`, "", "medium", 16),
    gp("contrast-hanmen", "N3", "反面", `${FORM_CHUNK}反面`, "", "medium", 16),
    gp("substitution-kawari-ni", "N3", "かわりに", `${FORM_CHUNK}かわりに`, "", "medium", 16),
    gp("topic-ni-kanshite", "N3", "に関して", `${FORM_CHUNK}に関して`, "", "high", 17),
    gp("comparison-ni-kurabete", "N3", "に比べて", `${FORM_CHUNK}に比べて`, "", "high", 17),
    gp("basis-ni-motozuite", "N3", "に基づいて", `${FORM_CHUNK}に基づいて`, "", "high", 17),
    gp("following-ni-sotte", "N3", "に沿って", `${FORM_CHUNK}に沿って`, "", "medium", 17),
    gp("following-change-ni-shitagatte", "N3", "に従って", `${FORM_CHUNK}に従って`, "", "medium", 17),
    gp("change-ni-tsurete", "N3", "につれて", `${FORM_CHUNK}につれて`, "", "medium", 17),
    gp("together-to-tomo-ni", "N3", "とともに", `${FORM_CHUNK}とともに`, "", "medium", 17),
    gp("context-ni-oite", "N3", "において", `${FORM_CHUNK}において`, "", "high", 17),
    gp("means-wo-tsuujite-tooshite", "N3", "を通じて / を通して", `${FORM_CHUNK}を通(?:じて|して)`, "", "medium", 17),
    gp("representative-wo-hajime", "N3", "をはじめ", `${FORM_CHUNK}をはじめ`, "", "medium", 17),
    gp("limit-ni-kagiru-kagirazu", "N3", "に限る / に限らず", `${FORM_CHUNK}に限(?:る|ります|らない|らず|って)`, "", "medium", 17),
    gp("suffix-gachi", "N3", "がち", `${FORM_CHUNK}がち`, "", "medium", 24),
    gp("suffix-gimi", "N3", "気味", `${FORM_CHUNK}気味`, "", "medium", 24),
    gp("suffix-ge", "N3", "げ", `${FORM_CHUNK}げ`, "", "medium", 24),
    gp("suffix-ppoi", "N3", "っぽい", `${FORM_CHUNK}っぽい`, "", "medium", 24),
    gp("negative-youni-nai", "N3", "ようがない", `${FORM_CHUNK}ようが(?:ない|ありません)`, "", "high", 16),
    gp("impossible-kkonai", "N3", "っこない", `${FORM_CHUNK}っこない`, "", "medium", 18),
    gp("condition-kara-ni-wa", "N2", "からには", `${FORM_CHUNK}からには`, "", "high", 12),
    gp("qualification-kara-to-itte", "N2", "からといって", `${FORM_CHUNK}からといって`, "", "high", 12),
    gp("condition-nai-kagiri", "N2", "ない限り", `${FORM_CHUNK}ない限り`, "", "high", 12),
    gp("condition-ijou-wa", "N2", "以上は", `${FORM_CHUNK}以上は`, "", "high", 11),
    gp("condition-ue-wa", "N2", "上は", `${FORM_CHUNK}上は`, "", "high", 12),
    gp("sequence-ue-de", "N2", "上で", `${FORM_CHUNK}上で`, "", "high", 13),
    gp("addition-ue-ni", "N2", "上に", `${FORM_CHUNK}上に`, "", "high", 13),
    gp("viewpoint-kara-miru-to", "N2", "から見ると / からすると", `${FORM_CHUNK}から(?:見ると|見れば|すると|すれば|言うと|言えば)`, "", "medium", 16),
    gp("starting-kara-shite", "N2", "からして", `${FORM_CHUNK}からして`, "", "medium", 16),
    gp("concession-ni-shitemo-toshitemo", "N2", "にしても / としても", `${FORM_CHUNK}(?:にしても|としても)`, "", "high", 14),
    gp("concession-ni-shiro-ni-seyo", "N2", "にしろ / にせよ", `${FORM_CHUNK}に(?:しろ|せよ)`, "", "high", 14),
    gp("after-all-ageku", "N2", "あげく", `${FORM_CHUNK}あげく(?:に)?`, "", "high", 13),
    gp("after-effort-sue-ni", "N2", "末に", `${FORM_CHUNK}末に`, "", "high", 13),
    gp("only-ni-suginai", "N2", "にすぎない", `${FORM_CHUNK}にすぎ(?:ない|ません)`, "", "high", 14),
    gp("essence-ni-hoka-naranai", "N2", "にほかならない", `${FORM_CHUNK}にほかならない`, "", "high", 14),
    gp("necessity-zaru-wo-enai", "N2", "ざるを得ない", `${FORM_CHUNK}ざるを得(?:ない|ません)`, "", "high", 10),
    gp("compulsion-zu-ni-wa-irarenai", "N2", "ずにはいられない", `${FORM_CHUNK}(?:ずには|ないでは)いられ(?:ない|ません|なかった|ませんでした)`, "", "high", 10),
    gp("possibility-eru-enai", "N2", "得る / 得ない", `${FORM_CHUNK}得(?:る|ます|た|ました|ない|ません|なかった|ませんでした)`, "", "medium", 20),
    gp("risk-kanenai", "N2", "かねない", `${FORM_CHUNK}かね(?:ない|ません)`, "", "high", 14),
    gp("difficulty-kaneru", "N2", "かねる", `${FORM_CHUNK}かね(?:る|ます|た|ました)`, "", "high", 14),
    gp("emotion-te-naranai", "N2", "てならない", `${FORM_CHUNK}[てで]ならない`, "", "medium", 14),
    gp("emotion-te-tamaranai", "N2", "てたまらない", `${FORM_CHUNK}[てで]たまらない`, "", "medium", 14),
    gp("emotion-te-shouganai", "N2", "てしょうがない", `${FORM_CHUNK}[てで](?:しょうがない|仕方がない)`, "", "medium", 14),
    gp("timing-shidai", "N2", "次第", `${FORM_CHUNK}次第`, "", "medium", 16),
    gp("time-sai-ni", "N2", "際に", `${FORM_CHUNK}際に`, "", "high", 16),
    gp("occasion-ni-atatte", "N2", "にあたって", `${FORM_CHUNK}にあたって`, "", "high", 16),
    gp("occasion-ni-saishite", "N2", "に際して", `${FORM_CHUNK}に際して`, "", "high", 16),
    gp("prior-ni-sakidatte", "N2", "に先立って", `${FORM_CHUNK}に先立って`, "", "high", 16),
    gp("trigger-wo-kikkake-ni", "N2", "をきっかけに", `${FORM_CHUNK}をきっかけに`, "", "high", 16),
    gp("trigger-wo-keiki-ni", "N2", "を契機に", `${FORM_CHUNK}を契機に`, "", "medium", 16),
    gp("span-ni-watatte", "N2", "にわたって", `${FORM_CHUNK}にわたって`, "", "high", 17),
    gp("accompany-ni-tomonatte", "N2", "に伴って", `${FORM_CHUNK}に伴って`, "", "high", 17),
    gp("response-ni-oujite", "N2", "に応じて", `${FORM_CHUNK}に応じて`, "", "medium", 17),
    gp("basis-wo-fumaete", "N2", "を踏まえて", `${FORM_CHUNK}を踏まえて`, "", "high", 17),
    gp("merit-dake-atte", "N2", "だけあって", `${FORM_CHUNK}だけあって`, "", "medium", 16),
    gp("because-dake-ni", "N2", "だけに", `${FORM_CHUNK}だけに`, "", "medium", 16),
    gp("concession-youga-maiga", "N1", "ようが / まいが", `${FORM_CHUNK}(?:ろうが|ようが)${FORM_CHUNK}まいが`, "", "high", 8),
    gp("concession-nagara-mo", "N2", "ながらも", `${FORM_CHUNK}ながらも`, "", "medium", 16),
    gp("continuation-tsutsu", "N2", "つつ / つつある", `${FORM_CHUNK}つつ(?:ある)?`, "", "medium", 18),
    gp("cause-bakari-ni", "N2", "ばかりに", `${FORM_CHUNK}ばかりに`, "", "high", 15),
    gp("contrast-dokoro-ka", "N2", "どころか", `${FORM_CHUNK}どころか`, "", "high", 15),
    gp("impossible-dokoro-dewa-nai", "N2", "どころではない", `${FORM_CHUNK}どころではない`, "", "high", 15),
    gp("nonlimiting-dake-denaku", "N3", "だけでなく", `${FORM_CHUNK}だけでなく`, "", "high", 20),
    gp("regardless-ni-kakawarazu", "N2", "にかかわらず", `${FORM_CHUNK}にかかわらず`, "", "high", 16),
    gp("contrary-ni-hanshite", "N2", "に反して", `${FORM_CHUNK}に反して`, "", "high", 16),
    gp("addition-ni-kuwaete", "N2", "に加えて", `${FORM_CHUNK}に加えて`, "", "high", 16),
    gp("target-ni-kotaete", "N2", "に応えて", `${FORM_CHUNK}に(?:応|こた)えて`, "", "medium", 17),
    gp("center-wo-chuushin-ni", "N2", "を中心に", `${FORM_CHUNK}を中心に`, "", "high", 17),
    gp("regardless-wo-toyazu", "N2", "を問わず", `${FORM_CHUNK}を問わず`, "", "high", 16),
    gp("topic-wo-megutte", "N2", "をめぐって", `${FORM_CHUNK}をめぐって`, "", "high", 16),
    gp("direction-muke-muki", "N3", "向け / 向き", `${FORM_CHUNK}向(?:け|き)`, "", "medium", 22),
    gp("relative-wari-ni", "N2", "わりに", `${FORM_CHUNK}わりに`, "", "medium", 18),
    gp("memory-kke", "N2", "っけ", `${FORM_CHUNK}っけ`, "", "medium", 28),
    gp("quote-to-iu-yori", "N2", "というより", `${FORM_CHUNK}というより`, "", "medium", 18),
    gp("example-to-itta", "N2", "といった", `${FORM_CHUNK}といった(?=[^、。！？!?\\s])`, "", "medium", 20),
    gp("topic-to-ieba", "N2", "といえば", `${FORM_CHUNK}といえば`, "", "medium", 20),
    gp("thing-mono-da", "N2", "ものだ", `${FORM_CHUNK}もの(?:だ|です)`, "", "medium", 24),
    gp("cause-mono-dakara", "N2", "ものだから", `${FORM_CHUNK}ものだから`, "", "medium", 16),
    gp("concession-mono-no", "N2", "ものの", `${FORM_CHUNK}ものの`, "", "high", 16),
    gp("advice-koto-da", "N2", "ことだ", `${FORM_CHUNK}こと(?:だ|です)`, "", "medium", 22),
    gp("unnecessary-koto-wa-nai", "N2", "ことはない", `${FORM_CHUNK}ことは(?:ない|ありません)`, "", "high", 14),
    gp("double-negative-nai-koto-wa-nai", "N2", "ないことはない", `${FORM_CHUNK}ないことは(?:ない|ありません)`, "", "high", 13),
    gp("explanation-to-iu-koto-da", "N2", "ということだ", `${FORM_CHUNK}ということ(?:だ|です)`, "", "medium", 16),
    gp("nature-to-iu-mono-da", "N2", "というものだ", `${FORM_CHUNK}というもの(?:だ|です)`, "", "medium", 16),
    gp("not-nature-to-iu-mono-dewa-nai", "N2", "というものではない", `${FORM_CHUNK}というものでは(?:ない|ありません)`, "", "medium", 15),
    gp("wish-nai-mono-ka", "N2", "ないものか", `${FORM_CHUNK}ないものか`, "", "medium", 16),
    gp("instant-ga-hayai-ka", "N1", "が早いか", `${FORM_CHUNK}が早いか`, "", "high", 8),
    gp("instant-ya-inaya", "N1", "や否や", `${FORM_CHUNK}や否や`, "", "high", 8),
    gp("instant-nari", "N1", "なり", `${FORM_CHUNK}なり`, "", "medium", 12),
    gp("repetition-soba-kara", "N1", "そばから", `${FORM_CHUNK}そばから`, "", "high", 10),
    gp("unexpected-ka-to-omoi-kiya", "N1", "かと思いきや", `${FORM_CHUNK}かと思いきや`, "", "high", 10),
    gp("incidental-katagata", "N1", "かたがた", `${FORM_CHUNK}かたがた`, "", "medium", 14),
    gp("incidental-gatera", "N1", "がてら", `${FORM_CHUNK}がてら`, "", "medium", 14),
    gp("starting-wo-kawakiri-ni", "N1", "を皮切りに", `${FORM_CHUNK}を皮切りに`, "", "high", 14),
    gp("endpoint-wo-kagiri-ni", "N1", "を限りに", `${FORM_CHUNK}を限りに`, "", "high", 14),
    gp("means-wo-motte", "N1", "をもって", `${FORM_CHUNK}をもって`, "", "high", 14),
    gp("turning-wo-sakai-ni", "N1", "を境に", `${FORM_CHUNK}を境に`, "", "medium", 15),
    gp("range-ni-itaru-made", "N1", "に至るまで", `${FORM_CHUNK}に至るまで`, "", "high", 14),
    gp("stage-ni-itatte", "N1", "に至って", `${FORM_CHUNK}に至って(?:は|も)?`, "", "medium", 15),
    gp("context-ni-atte", "N1", "にあって", `${FORM_CHUNK}にあって`, "", "medium", 16),
    gp("standard-ni-sokushite", "N1", "に即して", `${FORM_CHUNK}に即して`, "", "high", 15),
    gp("exclusive-wo-oite", "N1", "をおいて", `${FORM_CHUNK}をおいて`, "", "high", 13),
    gp("defiance-wo-mono-to-mo-sezu", "N1", "をものともせず", `${FORM_CHUNK}をものともせず`, "", "high", 12),
    gp("forced-wo-yogi-naku-sareru", "N1", "を余儀なくされる", `${FORM_CHUNK}を余儀なくされ(?:る|ます|た|ました)`, "", "high", 10),
    gp("force-wo-yogi-naku-saseru", "N1", "を余儀なくさせる", `${FORM_CHUNK}を余儀なくさせ(?:る|ます|た|ました)`, "", "high", 10),
    gp("emotion-ni-taenai", "N1", "に堪えない", `${FORM_CHUNK}に堪え(?:ない|ません)`, "", "medium", 14),
    gp("reluctance-ni-shinobinai", "N1", "に忍びない", `${FORM_CHUNK}に忍びない`, "", "high", 13),
    gp("easy-inference-ni-katagunai", "N1", "に難くない", `${FORM_CHUNK}に難くない`, "", "high", 13),
    gp("worthy-ni-ataru", "N1", "に値する", `${FORM_CHUNK}に値する`, "", "high", 13),
    gp("sufficient-ni-taru", "N1", "に足る", `${FORM_CHUNK}に足る`, "", "medium", 13),
    gp("utmost-no-itari", "N1", "の至り", `${FORM_CHUNK}の至り`, "", "medium", 16),
    gp("extreme-kiwamaru-kiwamarinai", "N1", "極まる / 極まりない", `${FORM_CHUNK}(?:極まる|極まりない)`, "", "medium", 16),
    gp("deep-wish-te-yamanai", "N1", "てやまない", `${FORM_CHUNK}[てで]や(?:まない|みません)`, "", "high", 12),
    gp("since-te-kara-to-iu-mono", "N1", "てからというもの", `${FORM_CHUNK}[てで]からというもの`, "", "high", 10),
    gp("consequence-zu-ni-wa-okanai", "N1", "ずにはおかない", `${FORM_CHUNK}(?:ずには|ないでは)おかない`, "", "high", 10),
    gp("consequence-zu-ni-wa-sumanai", "N1", "ずにはすまない", `${FORM_CHUNK}(?:ずには|ないでは)すまない`, "", "high", 10),
    gp("prohibition-bekarazu", "N1", "べからず", `${FORM_CHUNK}べからず`, "", "high", 12),
    gp("improper-majiki", "N1", "まじき", `${FORM_CHUNK}まじき`, "", "high", 12),
    gp("role-taru-mono", "N1", "たるもの", `${FORM_CHUNK}たるもの`, "", "high", 12),
    gp("surprise-tomo-arou-mono-ga", "N1", "ともあろうものが", `${FORM_CHUNK}ともあろうものが`, "", "high", 12),
    gp("stage-tomo-naru-to", "N1", "ともなると", `${FORM_CHUNK}ともなると`, "", "medium", 14),
    gp("any-de-are", "N1", "であれ", `${FORM_CHUNK}であれ`, "", "medium", 16),
    gp("pair-to-ii-to-ii", "N1", "といい", `[^、。！？!?\\s]{1,24}といい[^、。！？!?\\s]{1,24}といい`, "", "medium", 18),
    gp("concession-to-wa-ie", "N1", "とはいえ", `${FORM_CHUNK}とはいえ`, "", "high", 14),
    gp("without-nakushite", "N1", "なくして", `${FORM_CHUNK}なくして`, "", "high", 13),
    gp("basis-atte-no", "N1", "あっての", `${FORM_CHUNK}あっての`, "", "medium", 13),
    gp("unique-nara-dewa", "N1", "ならでは", `${FORM_CHUNK}ならでは`, "", "high", 13),
    gp("covered-mamire", "N1", "まみれ", `${FORM_CHUNK}まみれ`, "", "medium", 20),
    gp("full-zukume", "N1", "ずくめ", `${FORM_CHUNK}ずくめ`, "", "medium", 20),
    gp("depending-ikan", "N1", "いかん", `${FORM_CHUNK}いかん(?:だ|で|によって|にかかわらず)?`, "", "medium", 16),
    gp("result-shimatsu-da", "N1", "始末だ", `${FORM_CHUNK}始末(?:だ|です)`, "", "medium", 18),
    gp("rhetorical-denakute-nandarou", "N1", "でなくてなんだろう", `${FORM_CHUNK}でなくてなんだろう`, "", "medium", 18),
    gp("extreme-to-ittara-nai", "N1", "といったらない", `${FORM_CHUNK}といったらない`, "", "medium", 18),
    gp("extreme-tara-aryashinai", "N1", "たらありゃしない", `${FORM_CHUNK}たらありゃしない`, "", "medium", 18),
    gp("best-ni-koshita-koto-wa-nai", "N2", "に越したことはない", `${FORM_CHUNK}に越したことは(?:ない|ありません)`, "", "high", 14),
    gp("excess-ni-mo-hodo-ga-aru", "N1", "にもほどがある", `${FORM_CHUNK}にもほどがある`, "", "high", 14),
    gp("emphatic-no-nanno", "N1", "のなんの", `${FORM_CHUNK}のなんの`, "", "medium", 22),
    gp("minimal-tari-tomo", "N1", "たりとも", `${FORM_CHUNK}たりとも`, "", "high", 14),
    gp("minimal-dani", "N1", "だに", `${FORM_CHUNK}だに`, "", "medium", 20),
    gp("minimal-sura", "N1", "すら", `${FORM_CHUNK}すら`, "", "medium", 20),
    gp("comparison-gotoki", "N1", "ごとき", `${FORM_CHUNK}ごとき`, "", "medium", 20),
    gp("suffix-meku", "N1", "めく", `${FORM_CHUNK}め(?:く|いて|き)`, "", "medium", 20),
    gp("unnecessary-made-mo-nai", "N1", "までもない", `${FORM_CHUNK}までもない`, "", "high", 14),
    gp("unnecessary-ni-wa-oyobanai", "N1", "には及ばない", `${FORM_CHUNK}には及(?:ばない|びません)`, "", "medium", 16),
    gp("situation-tokoro-wo", "N1", "ところを", `${FORM_CHUNK}ところを`, "", "high", 14),
];
