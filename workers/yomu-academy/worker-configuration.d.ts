/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.academy.jsonc workers/yomu-academy/worker-configuration.d.ts` (hash: 439d86d12646ef45b4cfa776382936a5)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 nodejs_compat
interface __BaseEnv_Env {
	ARCHIVE: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	ACADEMY_BASE_PATH: "/academy";
	SESSION_DAYS: "30";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACADEMY_BASE_PATH" | "SESSION_DAYS" | "INVITE_CODE_SECRET" | "ADMIN_TOKEN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_PRICE_ID">> {}
}
