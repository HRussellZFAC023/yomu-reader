...
**Active task:** `day:1:lesson-zero:02` - close the five-vowel listening journey with exact learning audio, story handoff, repair, delayed recall, optional bingo, persistence, responsive accessibility and clean browser proof; then continue through each standalone Lesson Zero activity in order before closing its composite games, World, social, study, wiki, accessibility, journal and evening rows.
