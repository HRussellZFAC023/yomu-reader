...
const HOSTED_DOCS_JA_COPY: Record<string, string> = {
    ...
    'Firefox extension packages now split the packaged Study app into readable local modules, keeping every JavaScript file within Mozilla Add-ons validation limits. This completes store delivery of the first-page onboarding and empty-dictionary setup path from 1.8.31 without minifying the source.': 'Firefox拡張機能では、同梱のStudyアプリを読みやすいローカルモジュールに分割し、すべてのJavaScriptファイルをMozilla Add-onsの検証上限内に収めました。ソースを縮小せずに、1.8.31で追加した最初のページでの初期設定と、辞書が空の場合のセットアップ導線をストアへ届けます。',
    ...
    'Install a dictionary from the catalogue or import any compatible Yomitan ZIP. Dictionary files, search indexes and local lookup results stay in the browser. Reorder sources so the answer you trust appears first.': 'カタログから辞書をインストールするか、対応するYomitan ZIPを取り込みます。辞書ファイル、検索索引、端末内の検索結果はブラウザーに残ります。信頼する答えが先に出るよう、出典の順番を変えます。',
    ...
    'Yomu ships definitions in 9 languages.': 'よむは9言語の語義を用意しています。',
    ...
    'The underline colours show pitch: blue stays flat, pink falls after the first beat, and amber falls later.': '下線の色はピッチを表します。青は平らなまま、ピンクは最初の拍の後で下がり、琥珀色はさらに後で下がります。',
    'A note from the person who made it': '作者からひとこと',
    'I built the thing I needed.': '自分に必要だったものを作りました。',
    'When I started Japanese, I was overwhelmed by the pile of tools I was supposed to understand before I could read anything. I spent a long time studying how to study. Then I built what I wished had existed: one place to read, watch, save words and come back to them. You should not have to repeat that homework.': '日本語を始めた頃、何かを読む前に理解しなければならない道具の多さに圧倒されました。勉強の仕方を学ぶことにも長い時間を使いました。そこで、当時あってほしかったものを作りました。読んだり、見たり、単語を保存して戻ったりできる一つの場所です。同じ下調べをあなたが繰り返す必要はありません。',
    'Comprehensible input': '理解可能なインプット',
    'Read things you can nearly understand.': 'あと少しで分かるものを読む。',
    'You pick up a language by understanding things said in it. When a sentence is mostly words you already know plus one you do not, the sentence itself teaches you the new word. Read and listen to Japanese you can nearly follow, in volume, and the gaps start to close.': 'その言語で話されていることを理解するうちに、言葉は身についていきます。ほとんどが知っている単語で、知らない単語が一つだけある文なら、文そのものが新しい単語を教えてくれます。だいたい分かる日本語をたくさん読み、聞くと、少しずつ穴が埋まっていきます。',
    'Keep the whole scene.': '場面ごと残す。',
    'Each word you save can carry a real example: a sentence from an actual show, with the audio of the line and a screenshot of the scene. The dictionary gives you the meaning. The clip shows you the moment it was used. When the word comes back in review, the scene comes back with it.': '保存した単語には、本物の用例を付けられます。実際の番組の文、その台詞の音声、場面の画像です。辞書は意味を教え、映像はその単語が使われた瞬間を見せます。復習で単語が戻るとき、場面も一緒に戻ります。',
    'How Yomu differs': 'よむの違い',
    'A plain comparison': '率直な比較',
    'Better than Migaku': 'Migakuより良いところ',
    "Yomu is free, and that includes Anki export and mobile. Install is one click from the Chrome or Firefox store, with no account before your first lookup. On a phone it runs in the browser you already have. Add any Yomitan dictionary, keep your RTK keywords, or study vocab only. Subtitles draw over the site's own player; switching Yomu off hands the page back untouched.": 'よむは無料で、Ankiへの書き出しとモバイル利用も含まれます。ChromeまたはFirefoxのストアからワンクリックで入り、最初の検索までアカウントは要りません。スマートフォンでは、いつものブラウザーで動きます。好きなYomitan辞書を追加し、RTKのキーワードを残すことも、語彙だけを学ぶこともできます。字幕はサイト本来のプレーヤー上に描かれ、よむを切るとページはそのまま元に戻ります。',
    'You choose what happens next': '次を決めるのはあなた',
    'Better than Duolingo': 'Duolingoより良いところ',
    'You pick the words, straight from the shows and manga you were already going to watch and read. Review sentences are the ones you found each word in, so practice sounds like real Japanese rather than a course script. There is no path and no energy meter. Study when you want, as much as you want. Mark a word known once and it stops turning up.': 'これから見る番組や読む漫画から、自分で単語を選びます。復習に出る文は、その単語を見つけたときのものなので、教材用の台本ではなく実際の日本語に触れられます。決められた道順もエネルギーメーターもありません。好きなときに、好きなだけ学べます。一度「既知」にした単語は出なくなります。',
    'Your collection': '自分の単語集',
    'Bring your own words.': '自分の単語を持ち込む。',
    'Already using Anki, jpdb, jiten or Bunpro? Keep using it. Yomu saves words there and shows what each one already knows. Migaku support is coming soon.': 'すでにAnki、jpdb、jiten、Bunproを使っていますか。そのまま続けてください。よむは単語をそこへ保存し、それぞれがすでに知っている単語を表示します。Migaku対応も準備中です。',
    'Or keep the words in Yomu. Its own deck uses the same SM-2 scheduling family Anki was built on, then carries the context with it: the sentence, grammar, pronunciation and handwriting practice.': '単語をよむの中に残すこともできます。内蔵デッキはAnkiの土台と同じSM-2系のスケジュールを使い、例文、文法、発音、手書き練習まで文脈ごと運びます。',
    'A way to use it': 'おすすめの使い方',
    'Build a core. Then read a lot.': '土台を作る。それから、たくさん読む。',
    'Your daily reviews wait in Study, and streaks record the days you return. The most common 2,000 words do most of the work: in everyday text, roughly four words out of five are drawn from them, and casual speech leans on them even more. That gives you a useful base. It does not give you fluency.': '毎日の復習はStudyで待っており、連続記録には戻ってきた日が残ります。最もよく使われる2,000語が多くを担います。日常的な文章では、およそ5語のうち4語がこの範囲から現れ、くだけた会話ではさらに割合が上がります。役に立つ土台にはなりますが、これだけで流暢にはなりません。',
    'What tadoku means.': '多読とは何か。',
    'Tadoku is extensive reading: lots of easy Japanese, read for the story rather than the study. It suits learners who can follow an easy story and want to read more without stopping at every line. The usual advice is to skip words you do not know so the story keeps moving.': '多読は、やさしい日本語をたくさん、勉強のためではなく物語を楽しむために読む方法です。やさしい話なら追えて、一行ごとに止まらず読む量を増やしたい学習者に向いています。知らない単語は飛ばし、物語を進めるのが一般的な助言です。',
    'Give the skip a memory.': '飛ばした単語を覚えておく。',
    'With Yomu, press the unknown word, keep reading, and return to it after you finish. You get the volume that makes tadoku work without losing every useful word forever.': 'よむなら、知らない単語を押し、そのまま読み、終わってから戻れます。多読に必要な量を保ちながら、役に立つ単語をずっと取りこぼすこともありません。',
    'Use the machinery you grew up with.': '育つ中で使った仕組みを、もう一度。',
    'Most of your first language arrived through thousands of encounters where the meaning was obvious. That machinery still works in adults. You can also do what a child cannot: notice a pattern, check a word, and go straight back to the page.': '母語の大部分は、意味が明らかな場面で何千回も出会ううちに身につきました。その仕組みは大人にも働きます。さらに大人なら、型に気づき、単語を確かめ、すぐページへ戻ることもできます。',
    'People learning together': '一緒に学ぶ人たち',
    ...
    'Furigana sits above the kanji. The underline colours teach pitch accent while you read: blue stays flat, pink falls early, and amber falls later. Open a PDF here, including a scanned one with OCR, or take the same reader to a web page.': 'ふりがなは漢字の上に付きます。下線の色は読みながらピッチアクセントを教えます。青は平らなまま、ピンクは早く下がり、琥珀色は後で下がります。ここでPDFを開けば、スキャンされたものもOCRで読めます。同じリーダーをウェブページへ持っていくこともできます。',
    ...
    'The desktop app captures the whole screen or a region you choose, reads the Japanese with OCR, and opens the result as words you can press and save. It is a separate download for Windows, macOS, Linux and Steam Deck.': 'デスクトップアプリが画面全体または選んだ範囲を取り込み、OCRで日本語を読み、押して保存できる単語として開きます。Windows、macOS、Linux、Steam Deck向けの別ダウンロードです。',
    'See Yomu Gaming': 'Yomu Gamingを見る',
    'capture': '取り込む',
    'read': '読む',
    'keep': '残す',
    'Coming': '準備中',
    'The Academy awaits.': 'Academyが待っています。',
    "Academy is a story-driven Japanese course from the first sounds to N1. Lessons happen through places, conversations and things you do, with Yomu's reading and review system underneath. It is open by invitation while it is built.": 'Academyは、最初の音からN1まで進む物語仕立ての日本語コースです。場所、会話、実際にすることを通して授業が進み、その下でよむの読解と復習の仕組みが動きます。開発中は招待制で公開しています。',
    'Visit the Academy': 'Academyを訪れる',
    'from first sounds': '最初の音から',
    'to N1': 'N1まで',
    'Use Yomu on this site': 'このサイトでよむを使う',
    'Four things you can use right now.': '今すぐ使える四つ。',
    ...
    'Did the userscript download instead?': 'ユーザースクリプトがダウンロードされましたか？',
    'Some managers save the file. Copy this URL and choose': 'ファイルを保存するマネージャーもあります。このURLをコピーし、マネージャーで',
    'in your manager:': 'を選んでください。',
