...
**Active task:** `day:1:lesson-zero:01` - finish the remaining authored-media proof for greeting Rie, then continue through each earlier standalone Lesson Zero activity in order before closing its composite games, World, social, study, wiki, accessibility, journal and evening rows.
