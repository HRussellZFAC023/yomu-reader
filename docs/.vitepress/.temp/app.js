...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"よむ","description":"A free JPDB and Yomitan popup reader for Japanese text, manga, video subtitles, and mining.","base":"/yomu-reader/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/yomu-icon.svg","nav":[{"text":"Getting Started","link":"/getting-started"},{"text":"Features","link":"/features"},{"text":"Local Audio","link":"/local-audio"},{"text":"Changelog","link":"/changelog"},{"text":"Support","link":"/support"},{"text":"Demo","link":"/newtab/index.html","target":"_self"}],"sidebar":[{"text":"Start","items":[{"text":"Overview","link":"/"},{"text":"Getting Started","link":"/getting-started"},{"text":"Features","link":"/features"},{"text":"Local Audio","link":"/local-audio"}]},{"text":"Project","items":[{"text":"Support","link":"/support"},{"text":"Changelog","link":"/changelog"}]}],"search":{"provider":"local"},"socialLinks":[{"icon":"github","link":"https://github.com/HRussellZFAC023/yomu-reader"}],"footer":{"message":"Free userscript now. Chrome, Firefox, and Safari extensions are coming soon.","copyright":"Released under the MIT license."}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CUl9Aggl.js"));
