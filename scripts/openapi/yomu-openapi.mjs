...
const academySchemas = {
    ...
    ExportPage: {
        ...
        properties: { schemaVersion: { type: 'integer' }, nextCursor: { type: ['string', 'null'] }, hasMore: { type: 'boolean' } },
        additionalProperties: true,
    },
    DeletedResource: {
        type: 'object',
        required: ['deleted', 'scope'],
        properties: { deleted: { type: 'boolean', const: true }, scope: { type: 'string', enum: ['profile', 'account'] } },
        additionalProperties: true,
    },
};
...
export const academyOperations = [
    ...
    { method: 'post', path: '/academy/api/auth/google/reader', operationId: 'createReaderAccountSession', tag: 'Authentication', summary: 'Start Reader account sign-in', description: 'Creates a free Reader account session without granting Academy curriculum access.', request: 'EmptyObject', response: 'Session', successStatus: 201, sameOrigin: true },
    ...
    { method: 'get', path: '/academy/api/account/export', operationId: 'exportAccountData', tag: 'Account', summary: 'Export account data', description: 'Returns a bounded page of account-owned data. Follow nextCursor until hasMore is false.', security: browser, parameters: cursorParameters, response: 'ExportPage' },
    { method: 'delete', path: '/academy/api/account', operationId: 'deleteAcademyAccount', tag: 'Account', summary: 'Delete the account', description: 'Permanently deletes the signed-in account and returns a deletion receipt.', security: browser, response: 'DeletedResource', sameOrigin: true },
    ...
    { method: 'get', path: '/academy/api/profile/export', operationId: 'exportProfileData', tag: 'Profiles', summary: 'Export profile data', description: 'Returns a bounded page of encrypted profile data.', security: browser, parameters: cursorParameters, response: 'ExportPage' },
    { method: 'delete', path: '/academy/api/profile', operationId: 'deleteAcademyProfile', tag: 'Profiles', summary: 'Delete the profile', description: 'Deletes an eligible profile and returns a deletion receipt.', security: browser, response: 'DeletedResource', sameOrigin: true },
