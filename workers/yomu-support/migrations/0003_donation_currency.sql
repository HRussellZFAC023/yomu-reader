-- Preserve the payer's native amount while storing a separately converted
-- reporting amount. A missing FX rate is explicit and never drops the event.

CREATE TABLE provider_donation_events_v2 (
...
INSERT INTO provider_donation_events_v2 (
  provider,
  event_id,
  day,
  amount_minor,
...
ALTER TABLE provider_donation_events_v2 RENAME TO provider_donation_events;
