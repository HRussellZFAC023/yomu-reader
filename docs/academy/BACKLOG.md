...
<a id="art-003"></a>
- [ ] **ART-003** Produce and approve coherent neutral portraits/sprites for every Academy and textbook speaking role plus four protagonists; correct likeness/style families before expanding poses/expressions, including Sam’s currently overlong hair against his supplied references, and enforce consent/name-only fallback at runtime. **Deps:** `ART-001`, `CAST-001`. **Proof:** `C,R,T,Q,S,O`.
<a id="art-004"></a>
