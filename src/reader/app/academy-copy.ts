...
const EN = {
    ...
    bridgeEyebrow: 'Joining this term',
    bridgeTitle: 'The chair is still yours.',
    bridgeBody: 'Rie catches you up on this term. Earlier memories stay in your journal.',
    ...
    navAchievementsSoon: 'Achievements · soon',
    navClassBoard: 'Class board',
    navClassBoardAccount: 'Class board · account',
    navChooseLesson: 'Choose lesson',
...
const JA: Record<AcademyCopyKey, string> = {
    ...
    bridgeEyebrow: '今学期から参加',
    bridgeTitle: 'あなたの椅子は、まだ空いています。',
    bridgeBody: 'りえ先生が今学期を紹介します。以前の思い出は日記に残っています。',
