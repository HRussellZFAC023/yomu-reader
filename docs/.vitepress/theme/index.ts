...
const HOSTED_DOCS_JA_COPY: Record<string, string> = {
    ...
    'Removed the standalone Undo study button; Previous now owns recent-review undo and otherwise no-ops on the first card.': '独立した学習用のUndoボタンを削除しました。直近レビューの取り消しはPreviousが担当し、それ以外で最初のカードにいる場合は何もしません。',
