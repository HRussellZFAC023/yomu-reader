...
| Nanako | warm, concise, naturally bilingual | learns when a gentle correction should become an invitation to participate | pragmatic messages, social repair, natural register | quietly rules that a dubious “Japanese” idea is not Japanese | returns to a changed class and asks the learner to welcome someone newer |
| Karen | friendly, direct, playful | turns enthusiasm and small daily habits into usable language rather than chasing game scores | beginner conversation, planning, game vocabulary, personal corpus | finds the vocabulary ceiling in every study game | restarts after time away and helps another learner return without guilt |
