...
describe('reader stylesheet loading', () => {
    ...
    it('uses scoped critical control CSS while the full reader CSS is unavailable', () => {
        ...
        expect(css).toContain('.jpdb-reader-word:is(.jpdb-pitch-unknown,[data-pitch-class=unknown]){--pc:var(--jpdb-reader-pitch-unknown);--pr:var(--jpdb-reader-pitch-unknown-readable);--c2:var(--pr,var(--pc,currentColor));--d2:#0000}');
