...
describe('D43 copy tiers are a property of the string', () => {
    ...
    it('keeps every tier rule, and the tier split, where it was measured', () => {
        ...
        expect(messages).toHaveLength(1247);
        expect(humanCritical).toHaveLength(389);

        // Split by WHAT classified each one. 383 are human-critical from their ID
        ...
        expect(byIdAlone).toHaveLength(383);
