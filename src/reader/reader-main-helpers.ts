...
import { collectVisibleTextTargets, readerWordSurfaceText } from './dom';
...
import type { ActivePointerTextLookup, PointerTextLookup } from './pointer-text-lookup';
...
import type { YomitanKanjiEntry, YomitanTermEntry } from './yomitan';
