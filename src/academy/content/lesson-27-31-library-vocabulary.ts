...
/** Backward-compatible name for callers written before the projection registry became open-ended. */
export const lesson27To31LibraryVocabularyDefinition = exactLibraryVocabularyDefinition;
