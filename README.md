...
- **Bring your dictionaries:** the starter follows both languages in your profile. For example, an English-speaking learner who chooses Spanish gets Spanish-headword terms with English definitions plus Spanish IPA. Japanese-target profiles keep the Japanese starter. Install more from Yomu's immutable catalogue, or import your own Yomitan ZIPs, JMdict, kanji, pronunciation, pitch, and frequency dictionaries.
