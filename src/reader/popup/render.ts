export { buildKanjiFacts, buildKanjiOriginGraph } from '../kanji/origin';
...
export { alignedExpressionComponentPitches, cardPronunciationReading, headwordComponentPitchSegments, isKanjiCharacter, renderExpressionComponentPitches, renderPitch, type ExpressionComponentLookup, type ExpressionComponentPitch } from './pitch';
