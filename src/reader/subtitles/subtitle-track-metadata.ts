...
import { inferSubtitleLanguage, normalizeSubtitleLanguage } from './subtitle-sources';
...
/**
 * Subtitle capability: "is this track in the language we are teaching?" The
 * comparison resolves through the active learning target. Note that the label
 * heuristics inside `inferSubtitleLanguage` are still Japanese-specific — only
 * the match is behind the contract.
 */
...
export { isTargetLanguageSubtitleTrack as isJapaneseSubtitleTrack };
